        ...
        <div class="container-fluid">
            <div class="middel_inner">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="logo">
                            <a href="index.jsp"><img src="http://localhost:8081/user/assets/img/logo/logo.png" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="cart_area">
                            ...
                            <ul>
                                ...
                                <li class="mega_items"><a href="shop.html">shop <i class="fa fa-angle-down"></i></a>
                                    <ul class="mega_menu">
                                        ...
                                        <li class="banner_menu"><a href="#"><img src="http://localhost:8081/user/assets/img/bg/banner1.jpg" alt=""></a></li>
                                    </ul>
                                </li>
