    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-3 col-md-5">
          <div class="logo">
            <a href="index.html"><img src="http://localhost:8082/user/assets/img/logo/logo.png" alt=""></a>
          </div>
        </div>
              ...
              <div class="main_menu">
                <nav>
                  <ul>
                    ...
                    <li class="mega_items active"><a href="shop.html">shop <i class="fa fa-angle-down"></i></a>
                      <ul class="mega_menu">
