...
<head>
  ...
  <title>Stock Detail - Vendor</title>
                    ...
                    <table class="table table-borderless datatable" id="stockTable">
                      ...
                      <c:forEach var="iv" items="${inventories}">
                        <tr>
                          ...
                          <td>${iv.size.product.name}</td>
                          <td><input class="box-content" style="background: ${iv.color.color_code}; width: 30px" disabled></td>
                          <td>${iv.size.size}</td>
                          <td>${iv.importQuantity}</td>
                          <td>${formatVND.format(iv.importPrice)}</td>
                        </tr>
                      </c:forEach>
                      </tbody>
                    </table>
