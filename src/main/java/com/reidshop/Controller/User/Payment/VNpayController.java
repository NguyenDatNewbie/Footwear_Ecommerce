...
public class VNpayController {
    ...
    @GetMapping("/vnpay")
    public ModelAndView getPay(@PathParam("receive") String receive, @PathParam("price") double price, HttpSession session) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String orderType = "other";
        long amount = (long) (price*100);
//        String bankCode = "VnMart";
